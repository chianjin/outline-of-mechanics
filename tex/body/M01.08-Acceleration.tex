...
\begin{tablex}[!h]
  ...
  \begin{tabularx}{\linewidth}{l|l|S}
    \toprule
    \makecell[c]{地\hspace{6.5em} 点} & \makecell[c]{纬\qquad 度} & $g$ （米/秒\textsuperscript{2}） \\
    \midrule
...
于速度时，表示速度方向没有变化，但速率增加。当二者反平
\clearpage\noindent
行时，表示速度方向不变，而速率减少。当加速度既不平行也不反
平行于速度时，表示速度方向也在变化。
...
\begin{tablex}[!h]
  ...
  \begin{tabularx}{\linewidth}{l*{17}{|C}}
    ...
    时~~~~间(秒)                              & 0 &   & 1 &   & 2 &   & 3  &    & 4  &    & 5  &    & 6  &    & 7  &    & 8   \\
    \midrule
    \makecell[l]{与参考点的距离\\\qquad$s$~~(米)}                        & 3 &   & 4 &   & 9 &   & 18 &    & 31 &    & 48 &    & 69 &    & 94 &    & 123 \\
    \makecell[l]{各秒内的位置变化\\\qquad$\Delta s$~~(米) }         &   & 1 &   & 5 &   & 9 &    & 13 &    & 17 &    & 21 &    & 25 &    & 29 &     \\
    \makecell[l]{各秒内的平均速度\\\qquad$v$~~(米/秒)}              &   & 1 &   & 5 &   & 9 &    & 13 &    & 17 &    & 21 &    & 25 &    & 29 &     \\
    \makecell[l]{各秒内的平均加速度\\\qquad$a$~~($\text{米/秒}^2$)} &   &   & 4 &   & 4 &   & 4  &    & 4  &    & 4  &    & 4  &    & 4  &    &     \\
    \bottomrule
  \end{tabularx}
\end{tablex}
\clearpage
